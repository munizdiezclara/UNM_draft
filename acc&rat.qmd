...
UNM07_training <- filter(training, !pNum %in% not_passed_pNum)
UNM07_test <- filter(test, !pNum %in% not_passed_pNum)
...
UNM08_training <- filter(training, !pNum %in% not_passed_pNum)
UNM08_test <- filter(test, !pNum %in% not_passed_pNum)

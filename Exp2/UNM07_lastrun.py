...
expName = 'UNM07'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'age': '',
    'gender': ["male","female", "non-binary", "other"],
    'condition': f"{randint(1, 3)}",
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\munizdie\\OneDrive - Lancaster University\\Experiments\\Recognition Memory\\UNM07\\UNM07_experiment\\UNM07_lastrun.py',
...
for thisConsent_loop in consent_loop:
    ...
    for thisCompr1_completed in compr1_completed:
        ...
        # set up handler to look after randomisation of conditions etc
        training_trials = data.TrialHandler(nReps=8.0, method='random', 
            extraInfo=expInfo, originPath=-1,
        ...
        # completed 8.0 repeats of 'training_trials'
        ...
        for thisVsubtle_loop in vsubtle_loop:
            ...
            test2_vsubtle_trials = data.TrialHandler(nReps=1.0, method='random', 
                extraInfo=expInfo, originPath=-1,
                trialList=data.importConditions(testFile),

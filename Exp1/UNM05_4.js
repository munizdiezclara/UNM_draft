...
function task2_instr_vsubtleLoopBegin(task2_instr_vsubtleLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTask2_instr_vsubtle of task2_instr_vsubtle) {
...
function test1_vsubtle_trialsLoopBegin(test1_vsubtle_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTest1_vsubtle_trial of test1_vsubtle_trials) {
...
function subtle_loopLoopBegin(subtle_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisSubtle_loop of subtle_loop) {
...
function task2_instr_subtleLoopBegin(task2_instr_subtleLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTask2_instr_subtle of task2_instr_subtle) {
...
function test1_subtle_trialsLoopBegin(test1_subtle_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTest1_subtle_trial of test1_subtle_trials) {
...
function task3_instr_subtleLoopBegin(task3_instr_subtleLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTask3_instr_subtle of task3_instr_subtle) {
...
function test2_subtle_trialsLoopBegin(test2_subtle_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTest2_subtle_trial of test2_subtle_trials) {
...
function nosubtle_loopLoopBegin(nosubtle_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisNosubtle_loop of nosubtle_loop) {
...
function task2_instr_nosubtleLoopBegin(task2_instr_nosubtleLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTask2_instr_nosubtle of task2_instr_nosubtle) {
...
function test1_nosubtle_trialsLoopBegin(test1_nosubtle_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTest1_nosubtle_trial of test1_nosubtle_trials) {
...
function task3_instr_nosubtleLoopBegin(task3_instr_nosubtleLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTask3_instr_nosubtle of task3_instr_nosubtle) {
...
function test2_nosubtle_trialsLoopBegin(test2_nosubtle_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTest2_nosubtle_trial of test2_nosubtle_trials) {
...
function test1_vsubtle_instRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_vsubtle_instComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function comprehension2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of comprehension2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_vsubtle_choiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_vsubtle_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_vsubtle_rateRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_vsubtle_rateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_subtle_instRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_subtle_instComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_subtle_choiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_subtle_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_subtle_rateRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_subtle_rateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test2_subtle_instRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test2_subtle_instComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test2_subtle_choiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test2_subtle_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test2_subtle_rateRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test2_subtle_rateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_nosubtle_instRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_nosubtle_instComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_nosubtle_choiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_nosubtle_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test1_nosubtle_rateRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test1_nosubtle_rateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test2_nosubtle_instRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test2_nosubtle_instComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test2_nosubtle_choiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test2_nosubtle_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test2_nosubtle_rateRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test2_nosubtle_rateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }

...
let expName = 'UNM07';  // from the Builder filename that created this script
let expInfo = {
    'participant': '',
    'age': '',
    'gender': ["male", "female", "non-binary", "other"],
    'condition': `${util.randint(1, 3)}`,
};
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'training_certain.xlsx', 'path': 'training_certain.xlsx'},
    ...
    {'name': 'pilot_test2_certain_trials.xlsx', 'path': 'pilot_test2_certain_trials.xlsx'},
    ...
    {'name': 'instructions/exmple_cue.png', 'path': 'instructions/exmple_cue.png'},
    {'name': 'instructions/info3.png', 'path': 'instructions/info3.png'},
    {'name': 'task1_instructions.xlsx', 'path': 'task1_instructions.xlsx'},
    {'name': 'pilot_test2_uncertain_trials.xlsx', 'path': 'pilot_test2_uncertain_trials.xlsx'},
    {'name': 'instructions/info1.png', 'path': 'instructions/info1.png'},
    {'name': 'training_uncertain.xlsx', 'path': 'training_uncertain.xlsx'},
    ...
    {'name': 'instructions/example_outcome.png', 'path': 'instructions/example_outcome.png'},
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.co/submissions/complete?cc=CBALPD1N', '');
...
async function experimentInit() {
  ...
  if ((Number.parseInt(expInfo["condition"]) === 1)) {
      trainingFile = "training_certain.xlsx";
      testFile = "test2_certain_trials.xlsx";
  } else {
      if ((Number.parseInt(expInfo["condition"]) === 2)) {
          trainingFile = "training_uncertain.xlsx";
          testFile = "test2_uncertain_trials.xlsx";
      }
  }
